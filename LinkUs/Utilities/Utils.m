...
+(NSString*)remaningTime:(NSDate*)startDate endDate:(NSDate*)endDate {
    ...
    if (days > 0) {
        ...
        if (days > 1) {
           ...
           // days
            ...
            durationString = [NSString stringWithFormat:@"أيام %ld", (long)days];
        }
        else {
            
           // day
            durationString = [NSString stringWithFormat:@"يوم %ld", (long)days];
        }
    ...
    if (hour > 0) {
        ...
        if (hour > 1) {
           // hours
            durationString = [NSString stringWithFormat:@"ساعة %ld", (long)hour];
        }
        else {
            //hour
            durationString = [NSString stringWithFormat:@"ساعة %ld", (long)hour];
    ...
    if (minutes > 0) {
        ...
        if (minutes > 1) {
            ...
            //minutes
            durationString = [NSString stringWithFormat:@"دقائق %ld", (long)minutes];
        }
        else {
            //minute
            durationString = [NSString stringWithFormat:@"دقيقة %ld", (long)minutes];
        }
        return durationString;
    }
